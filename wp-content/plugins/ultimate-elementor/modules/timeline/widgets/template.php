					...
					<div <?php echo $this->get_render_attribute_string( 'current_' . $item['_id'] ); ?>>
						<div <?php echo $this->get_render_attribute_string( 'data_alignment' . $item['_id'] ); ?>>
							<div class="uael-timeline-marker">
								<span <?php echo $this->get_render_attribute_string( 'card_' . $item['_id'] ); ?>>
									<?php
										...
										if ( UAEL_Helper::is_elementor_updated() ) {
											if ( isset( $settings['timeline_all_icon'] ) || isset( $settings['new_timeline_all_icon'] ) ) {
												...
												if ( $timeline_all_migrated || $timeline_all_is_new ) {
													...
													\Elementor\Icons_Manager::render_icon( $settings['new_timeline_all_icon'], [ 'aria-hidden' => 'true' ] );
												} elseif ( ! empty( $settings['timeline_all_icon'] ) ) {
													?>
													<i class="<?php echo $settings['timeline_all_icon']; ?>" aria-hidden="true"></i>
													<?php
												}
											}
										} elseif ( ! empty( $settings['timeline_all_icon'] ) ) {
										...
										if ( UAEL_Helper::is_elementor_updated() ) {
											if ( isset( $item['timeline_single_icon'] ) || isset( $item['new_timeline_single_icon'] ) ) {
												...
												if ( $timeline_single_migrated || $timeline_single_is_new ) {
													\Elementor\Icons_Manager::render_icon( $item['new_timeline_single_icon'], [ 'aria-hidden' => 'true' ] );
												} elseif ( ! empty( $item['timeline_single_icon'] ) ) {
													?>
													<i class="<?php echo $item['timeline_single_icon']; ?>" aria-hidden="true"></i>
													<?php
												}
											}
