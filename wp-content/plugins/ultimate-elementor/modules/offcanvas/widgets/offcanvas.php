...
class Offcanvas extends Common_Widget {
	...
	protected function render_action_html() {
		...
		if ( 'button' === $settings['offcanvas_on'] ) {
			...
			?>
			<div <?php echo $this->get_render_attribute_string( 'action-wrap' ); ?>><span class="uael-offcanvas-icon-bg uael-offcanvas-icon <?php echo $position; ?>"><?php echo $inner_html; ?></span></div>
			<?php
		}
	}
