...
<div class="uael-post-wrapper <?php echo $this->get_masonry_classes(); ?> <?php echo ( $is_featured && 1 < $query->post_count ) ? 'uael-post-wrapper-featured' : ''; ?>">
	...
	<div class="uael-post__bg-wrap">
		...
		<?php $this->render_featured_image(); ?>
			...
			<div class="uael-post__content-wrap <?php echo $this->get_no_image_class(); ?>">
