						...
						if ( $has_icon ) {
							...
							<div class="uael-icon-wrap">
								<span class="uael-icon">
									<?php
									if ( $is_new || $migrated ) {
										\Elementor\Icons_Manager::render_icon( $settings['new_heading_icon'], [ 'aria-hidden' => 'true' ] );
									} elseif ( ! empty( $settings['heading_icon'] ) ) {
										?>
										<i class="<?php echo $settings['heading_icon']; ?>" aria-hidden="true"></i>
									<?php } ?>
		...
		<div class="uael-module-content uael-heading-wrapper">
			...
			<<?php echo $settings['heading_tag']; ?> class="uael-heading">
				<?php if ( ! empty( $dynamic_settings['heading_link']['url'] ) ) { ?>
					<a <?php echo $link; ?> >
				<?php } ?>
						<span class="uael-heading-text elementor-inline-editing uael-size--<?php echo $settings['size']; ?>" data-elementor-setting-key="heading_title" data-elementor-inline-editing-toolbar="basic" ><?php echo $this->get_settings_for_display( 'heading_title' ); ?></span>
				<?php if ( ! empty( $dynamic_settings['heading_link']['url'] ) ) { ?>
					</a>
				<?php } ?>
			...
			<?php if ( '' !== $dynamic_settings['sub_heading'] ) { ?>
				<div class="uael-sub-heading elementor-inline-editing" data-elementor-setting-key="sub_heading" data-elementor-inline-editing-toolbar="advanced" ><?php echo $this->get_settings_for_display( 'sub_heading' ); ?></div>
				<?php } ?>
