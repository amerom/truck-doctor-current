 ...
 * Version: 1.19.2
 * Description: Ultimate Addons is a premium extension for Elementor that adds 30+ widgets and works on top of any Elementor Package (Free, Pro). You can use it with any WordPress theme.
 * Text Domain: uael
 *
 * @package UAEL
 */
